...
enum Operation { 
  ...
  static Operation parseJson(int value)
  => const {0: delete, 1: insert, 2: equal}[value]!;
...
class DiffMatchPatch {
  ...
  List<Diff> _diff_bisect(String text1, String text2, DateTime deadline) {
    ...
    final v1 = List.filled(v_length, -1);
    final v2 = List.filled(v_length, -1);
    v1[v_offset + 1] = 0;
    v2[v_offset + 1] = 0;
    ...
    return [
      Diff(Operation.delete, text1),
      Diff(Operation.insert, text2)
    ];
  }
  ...
  final whitespaceRegex_ = RegExp(r'\s');
  final linebreakRegex_ = RegExp(r'[\r\n]');
  final blanklineEndRegex_ = RegExp(r'\n\r?\n$');
